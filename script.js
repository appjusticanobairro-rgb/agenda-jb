...
async function cancelarAgendamento() {
    if (confirm("Tem certeza que deseja CANCELAR este agendamento? Ele serﾃ｡ excluﾃｭdo permanentemente da nuvem.")) {
        ...
        if (agendamentoData && agendamentoData.codigo) {
            ...
            // Se ainda nﾃ｣o salvou na nuvem, apenas reseta
            hideLoading();
            resetFormularioAgendamento();
        }
    }
...
function resetFormularioAgendamento() {
    ...
    // Volta sempre para a p疊ina de agendamento, o mostrarPaginaAgendamento cuida de mostrar a senha se necess疵io
    ...
    if (horarioHelp) horarioHelp.textContent = "Selecione uma data para ver os hor疵ios";
}



// --- NAVEGAﾃ�グ Pﾃ咤LICA & PESQUISA ---
